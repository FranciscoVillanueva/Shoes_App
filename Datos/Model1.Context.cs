...
namespace Datos
{
    ...
    public partial class DataProductsEntities1 : DbContext
    {
        ...
        public virtual ObjectResult<Products> BuscaProductoPorID(Nullable<int> productId)
        {
            var productIdParameter = productId.HasValue ?
                new ObjectParameter("ProductId", productId) :
                new ObjectParameter("ProductId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Products>("BuscaProductoPorID", productIdParameter);
        }
    
        public virtual ObjectResult<Products> BuscaProductoPorID(Nullable<int> productId, MergeOption mergeOption)
        {
            var productIdParameter = productId.HasValue ?
                new ObjectParameter("ProductId", productId) :
                new ObjectParameter("ProductId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Products>("BuscaProductoPorID", mergeOption, productIdParameter);
        }
    
        public virtual ObjectResult<Products> BuscaProductoPorNombre(string productName)
        {
            var productNameParameter = productName != null ?
                new ObjectParameter("ProductName", productName) :
                new ObjectParameter("ProductName", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Products>("BuscaProductoPorNombre", productNameParameter);
        }
    
        public virtual ObjectResult<Products> BuscaProductoPorNombre(string productName, MergeOption mergeOption)
        {
            var productNameParameter = productName != null ?
                new ObjectParameter("ProductName", productName) :
                new ObjectParameter("ProductName", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Products>("BuscaProductoPorNombre", mergeOption, productNameParameter);
        }
        ...
        public virtual int ACOB_InsertImages(Nullable<int> idImage, Nullable<int> idProduct, string descripcion, byte[] image, Nullable<System.DateTime> dateUpdate, string isEnable)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ACOB_InsertImages", idImageParameter, idProductParameter, descripcionParameter, imageParameter, dateUpdateParameter, isEnableParameter);
        }
